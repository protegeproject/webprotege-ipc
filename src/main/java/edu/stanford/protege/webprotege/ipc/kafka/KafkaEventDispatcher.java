...
import edu.stanford.protege.webprotege.ipc.EventDispatchException;
...
public class KafkaEventDispatcher implements EventDispatcher {
    ...
    public KafkaEventDispatcher(KafkaTemplate<String, String> kafkaTemplate, ObjectMapper objectMapper) {
